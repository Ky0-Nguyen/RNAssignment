...
## Step 1: Install the Metro Server

First, you will need to install **Metro**, the JavaScript _bundler_ that ships _with_ React Native.
...
>**Note**: For the run IOS app you need to run [pod install]
```bash
